...
(function() {
	...
	jQuery.sap.declare("vale.im.mobile.Component");

	sap.ui.core.UIComponent.extend("vale.im.mobile.Component", {

		createContent: function() {
			// create root view
			var oView = sap.ui.view({
				id: "idViewRoot",
				viewName: "vale.im.mobile.view.Root",
				type: "XML",
				viewData: {
					component: this
				}
			...
			var sURI = "http://localhost:80/Northwind/Northwind.svc/";
